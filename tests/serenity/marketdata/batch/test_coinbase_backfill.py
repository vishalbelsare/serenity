...
from serenity.marketdata.batch.coinbasepro_backfill import backfill_coinbase_trades
...
def test_backfill_coinbase_trades(mocker: MockFixture):
    ...
    mock_tickstore = mocker.patch('serenity.marketdata.batch.coinbasepro_backfill.LocalTickstore').return_value
